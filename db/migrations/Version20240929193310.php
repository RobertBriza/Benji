 ...
 */
final class Version20240929193310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD removed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD create_date DATE NOT NULL');
